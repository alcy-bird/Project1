<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="KategoriDetay.aspx.cs" Inherits="Project1.KategoriDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
        <table class="auto-style5">
            <tr>
                <td class="auto-style8"><strong><a href="YemekDetay.aspx?yemek_id=<%#Eval("yemek_id") %>">
                    <asp:Label ID="Label3" runat="server" CssClass="a auto-style6" Text='<%# Eval("yemek_adi") %>'></asp:Label>
                    </a></strong></td>
            </tr>
            <tr>
